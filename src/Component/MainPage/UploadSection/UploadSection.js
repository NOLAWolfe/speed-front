    ...
    return (
      <div>
        ...
        <Dialog aria-labelledby="simple-dialog-title" className="upload__dialogbox" open={this.state.open}>
            ...
            <input type="text" className="upload__textbox" placeholder="What's on your mind, {user.name}"/>
            <img src={this.state.uploadImage} className="upload__preview" alt=""/>
            <input type="button" value="Post" className="upload__button" />
        </Dialog>
